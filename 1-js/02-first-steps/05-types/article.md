...
```js
let str = "Hello";
let str2 = 'Les guillemets simples sont aussi ok';
let phrase = `peut incorporer ${str}`;
```
...
```js run
alert( "le résultat est ${1 + 2}" ); // le résultat est ${1 + 2} (les doubles quotes ne font rien)
```
