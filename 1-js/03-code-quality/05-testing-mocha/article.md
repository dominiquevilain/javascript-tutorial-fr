...
describe("pow", function() {
  ...
  it("élève à la puissance n", function() {
...
1. La première variante - ajoute une autre `assert` dans le même `it` :
    ...
    describe("pow", function() {
      ...
      it("élève à la n-ième puissance", function() {
        assert.equal(pow(2, 3), 8);
    *!*
...
2. La seconde -- faire deux tests :
    ...
    describe("pow", function() {
      ...
      it("2 élevé à la puissance 3 est 8", function() {
        assert.equal(pow(2, 3), 8);
      });

      it("3 élevé à la puissance 3 est 27", function() {
...
describe("test", function() {
  ...
  before(() => alert("Test commencé - avant tous les tests"));
  after(() => alert("Test terminé - après tous les tests"));

  beforeEach(() => alert("Avant un test - entrer un test"));
  afterEach(() => alert("Après un test - quitter un test"));
...
describe("pow", function() {
  ...
  it("pour un n négatif, le résultat est NaN", function() {
*!*
    assert.isNaN(pow(2, -1));
*/!*
  });

  it("pour un non-entier n le résultat est NaN", function() {
*!*
